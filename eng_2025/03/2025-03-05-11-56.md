...
[Kwaak](https://github.com/bosun-ai/kwaak) has appeared in alpha version - another terminal tool. It enables running autonomous AI agent commands directly from the terminal in parallel.

A fork of [bolt.diy](https://github.com/stackblitz-labs/bolt.diy) (which itself is a fork of blot.new) has emerged, called "[Nut.new](https://nut.new/)".
