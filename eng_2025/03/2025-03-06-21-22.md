...
- **Detailed Specification:** Start with a _very_ detailed specification of the application. Use an AI (like Groq 3 in the video) to help generate this spec, including technical details, database schema, API endpoints, etc.
...
#agentmode #cursor #windsurf #prompts 