...
This repository contains a table of available projects that provide free, limited access to the best models. For example, **Rovo Dev CLI** gives 4.5 million tokens per day on Claude Sonnet 4. **Gemini CLI** provides 100 requests per day on the Gemini 2.5 Pro model. It also states whether a credit card number is required.
