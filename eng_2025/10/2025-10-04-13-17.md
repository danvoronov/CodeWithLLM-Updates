...
The Jules cloud agent has a rather imperfect web interface from which it is unclear what it is currently doing - but it gives as many as **15 tasks a day** without paying for tokens. Now you can install `npm install -g @google/jules` locally, all commands `jules help`.
