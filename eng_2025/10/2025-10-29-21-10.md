...
A significant update to one of the main AI coding tools. Cursor decided to respond to Windsurf and also created **its own model** specifically for software development. They named it "Composer" and claim it's 4 times faster than models with similar intelligence, but I think this is just to pay less to external providers.
