...
The main focus of the announcement is **Interactive Collaboration**. You can "steer" mid-execution—meaning you can stop the model, re-prompt it, and it will **immediately** shift its strategy. This contrasts with Opus 4.6, which attempts to work for long periods without human intervention.
