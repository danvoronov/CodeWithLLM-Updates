**Supabase** 
https://supabase.com/
альтернатива Firebase з відкритим кодом та SQL базою даних. Виклали у себе на ютуб каналі приклад використання їх сервіса разом с [bolt.new](https://bolt.new/):
