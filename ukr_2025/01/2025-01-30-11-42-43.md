...
(раніше OpenDevin). Open Source Python інструмент, натхнений [Devin](https://app.devin.ai/) 'ом, запуску агентів для програмування: пише код, виконує команди, заходить в інтернет. 
