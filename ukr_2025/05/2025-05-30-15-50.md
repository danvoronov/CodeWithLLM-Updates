...
Ціна на АПІ така сама та все ще є знижки в ночі (по Китаю). У веб-версії https://chat.deepseek.com/ використання безкоштовне, але це єдина з SOTA моделей у якої зараз н**емає в чаті canvas**-інтерфейсу. До речі, нарешті додали можливість у налаштування (Improve the model for everyone) відключити збір даних для тренування їх моделей.
